...
/***/ function(module, exports, __webpack_require__) {
	...
	const validation_1 = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const visit_1 = __webpack_require__(121);
	const text_1 = __webpack_require__(122);
	const shahokokuho_1 = __webpack_require__(123);
	const koukikourei_1 = __webpack_require__(124);
	const roujin_1 = __webpack_require__(125);
	const kouhi_1 = __webpack_require__(126);
	const full_drug_1 = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function drugRep(drug) {
	    switch (drug.category) {
	        case mConsts.DrugCategoryNaifuku:
	            return `${drug.name} ${drug.amount}${drug.unit} ${drug.usage} ${drug.days}日分`;
	        case mConsts.DrugCategoryTonpuku:
	            return `${drug.name} １回 ${drug.amount}${drug.unit} ${drug.usage} ${drug.days}回分`;
	        case mConsts.DrugCategoryGaiyou:
	            return `${drug.name} ${drug.amount}${drug.unit} ${drug.usage}`;
	        default:
