import { FullDrug } from "./model";
import * as mConsts from "myclinic-consts";

export function drugRep(drug: FullDrug){
...
export function conductKindToKanji(kind: number): string {
	switch(kind){
